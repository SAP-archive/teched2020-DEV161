...
2. Close the *Outline* view and all open tabs in the editors section, except the *Welcome* tab.
    ...
    >Tip: To close all open tabs except the *Welcome* tab, click the *Welcome* tab title to select it, right-click the *Welcome* tab title and select *Close Others*. Explore this to see additional options.
