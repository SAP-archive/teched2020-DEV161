...
- [Exercise 4 - Test the Application with Mock Server](exercises/ex2/)
    ...
    - [Exercise 2.2 - Run the Application with Auto-Generated Mock Data](exercises/ex2#exercise-22-sub-exercise-2-description)
    - [Exercise 2.2 - Load Data to Mock Server](exercises/ex2#exercise-22-sub-exercise-2-description)
    - [Exercise 2.2 - Run the app with User Provided Mock Data](exercises/ex2#exercise-22-sub-exercise-2-description)
